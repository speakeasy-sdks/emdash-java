...
public class GetMarketRequest {
    ...
    public GetMarketRequest withSystemSymbol(String systemSymbol) {
    ...
    public GetMarketRequest withWaypointSymbol(String waypointSymbol) {
        this.waypointSymbol = waypointSymbol;
        return this;
    }
    
    public GetMarketRequest(@JsonProperty("systemSymbol") String systemSymbol, @JsonProperty("waypointSymbol") String waypointSymbol) {
        this.systemSymbol = systemSymbol;
        this.waypointSymbol = waypointSymbol;
  }
}
